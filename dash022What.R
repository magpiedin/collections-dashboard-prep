...
#WhatDash4$DarDesc01 <- gsub(" \\| | ", " | ", WhatDash4$DarRelatedInformation)
...
#WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub(" \\| | ", " | ", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")])
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub("[[:punct:]]|\\|", " ", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")])
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub(paste(CutFirst, collapse="|"), " ", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")], ignore.case = T)
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub(paste0(CutWords, collapse="|"), " ", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")], ignore.case = T)
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub(" [[:alpha:]]{1} |^[[:alpha:]]{1} ", " ", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")], ignore.case = T)
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub("^\\s+|\\s+$", "", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")])
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub("\\s+", " ", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")])
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- sapply(WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")], simpleCap)
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub(" ", " | ", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")])
WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")] <- gsub("(\\|\\s+)+", "| ", WhatDash4$DarScientificName[which(WhatDash4$DarCollectionCode=="Anthropology")])
